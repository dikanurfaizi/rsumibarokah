...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><?php echo "<img src='../../dist/img/favicon.ico' width='75' height='75'>" ?><br>
    <h6><b>RUMAH SAKIT UMI BAROKAH</b></h6></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="action-login.php" method="POST">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Kata Sandi" name="sandi">
          <div class="input-group-append">
            <div class="input-group-text">
