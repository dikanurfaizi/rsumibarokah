        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pelayanan Publik</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <p class="text-sm mb-0 float-sm-right">
                  Melihat seluruh data pelayanan publik, klik <a href="view_pelayanan.php">disini</a>
                </p>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form role="form" action="../../conf/pelayanan/insert_pelayanan.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group col-sm-12">
                        ...
                        <div>
                          <input type="text" class="form-control" name="jenis" placeholder="Jenis Pelayanan">
                        </div>
                      </div>
                      <div class="form-group col-sm-12">
                        <label class="col-form-label">Nama Pelayanan</label>
                        <div>
                          <input type="text" class="form-control" name="nama" placeholder="Nama Pelayanan">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <p class="text-sm mb-0">
                    Editor <a href="">pelayanan publik.</a>
                  </p>
                </div>
              </form>
            </div>
