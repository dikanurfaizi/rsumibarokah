          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Mengubah Profil RS Umi Barokah</h3>
                <p class="text-sm mb-0 float-sm-right">
                  Melihat seluruh informasi profil, klik <a href="view_profil.php">disini</a>
                </p>
              </div>
              <!-- /.card-header -->
              ...
              <!-- form start -->
              <form role="form" action="../../conf/profil/update_profil.php?id=<?php echo $row['kd_profil']?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <!-- left column inside form-->
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group col-sm-12">
                        <label class="col-form-label">Kategori Profil</label>
                        <div>
                  ...
                  <div class="col-sm-6">
                    <div class="card-body">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <div class="custom-file">
                          <div><?php echo "<img src='../../../images/profil/".$row['nm_foto']."' width='150' height='150'>" ?></div>  
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <p class="text-sm mb-0">
                    Editor <a href="">dokumen: informasi profil.</a>
                  </p>
                </div>
              </form>
          	<?php } ?>
