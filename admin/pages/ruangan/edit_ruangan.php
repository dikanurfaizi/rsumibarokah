        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="view_profil.php">Ruangan</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Mengubah Informasi Ruangan</h3>
              ...
              $no_ruangan=$_GET['id'];
              $hasil = mysqli_query($connect,"select * from ruangan WHERE no='$no_ruangan'");
              while($row=mysqli_fetch_array($hasil)){
              ?>

              <!-- form start -->
              <form role="form" action="../../conf/ruangan/update_ruangan.php?no=<?php echo $row['no']?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group col-sm-12">
                        ...
                        <div>
                          <input type="text" class="col-sm-12 form-control" name="jenis" value="<?php echo $row['kategori'] ?>">
                        </div>
                      </div>
                      <div class="form-group col-sm-12">
                        <label class="col-form-label">Nama Ruangan</label>
                        <div>
                          <input type="text" class="form-control" name="nama" value="<?php echo $row['nm_ruangan'] ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="card-body">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <div class="custom-file">
                          <div><?php echo "<img src='../../../images/ruangan/".$row['nm_foto']."' width='150' height='150'>" ?></div>  
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <p class="text-sm mb-0">
                    Editor <a href="">dokumen: informasi ruangan.</a>
                  </p>
                </div>
              </form>
          	<?php } ?>
