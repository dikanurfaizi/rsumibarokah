...
<section id="acara" class="our-blog gray-bg page-section-ptb">
  <div class="container">
    <div class="row">
     <div class="col-lg-12 col-md-12">
       <div class="section-title line center text-center">
        <h6 class="subtitle"><br><br>Sekilas Info</br></br></h6> 
    ...
    <?php 
      ...
      $kategori = $_GET['kt'];
      $hasil = mysqli_query($connect,"SELECT * FROM artikel WHERE kategori='$kategori' ORDER BY kd DESC LIMIT 0,12");
      while($row=mysqli_fetch_array($hasil)){ 
    ?>
      <div class="col-lg-4 col-md-4 sm-mb-30">
        <div class="blog-box blog-2 white-bg h-100">
          <img width="100%" height="100%" class="img-fluid" src="images/articles/<?php echo $row['nm_gbr'] ?>" alt="">
          <div class="blog-info">
            <span class="post-category"><a href="#"><?php echo $row['kategori'] ?></a></span>
            <h4> <a href="#"> <?php echo $row['judul'] ?></a></h4>
            <p><?php echo $row['tag'] ?></p>
            <span><i class="fa fa-calendar-check-o"></i> <?php echo date('d-m-Y', strtotime($row['waktu_upload'])) ?> </span>
            <a class="button icon-color" href="detail_artikel.php?id=<?php echo $row['kd'] ?>">Read More<i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    <?php } ?>
