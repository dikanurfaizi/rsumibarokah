      ...
      <div class="col-lg-12 col-md-12">
        <div class="blog-box blog-2 white-bg h-100 line center">
          <div class="blog-info">
            ...
            <span><i class="fa fa-calendar-check-o"></i> <?php echo date('d-m-Y', strtotime($show['waktu_upload'])) ?> </span>
            <br>
            <div style="text-align: justify; width:100%; padding:8px;"><img style="float: left; margin:0 8px 4px 0;" width="40%" height="40%" src="images/articles/<?php echo $show['nm_gbr'] ?>"><?php echo $show['konten'] ?>
            </div>
          </div>
        </div>
      </div>
