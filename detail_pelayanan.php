...
$jenis = $_GET['jn'];
$hasil = mysqli_query($connect,"SELECT * FROM pelayanan WHERE judul LIKE '%$jenis' OR nm_pelayanan LIKE '%$jenis'");
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
       <div class="section-title line center text-center">
        <i><h6 class="subtitle"><a href="#"><br>Pelayanan</h6></i>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="blog-box blog-2 white-bg h-100 line center">
          <div class="blog-info">
            ...
            <span class="post-category"><a href="#"><?php echo $show['nm_pelayanan'] ?></a></span>
            <span><i class="fa fa-calendar-check-o"></i> <?php echo date('d-m-Y', strtotime($show['upload'])) ?> </span>
            <br>
            <div style="text-align: justify; width:100%; padding:8px;"><img style="float: left; margin:0 8px 4px 0;" width="40%" height="40%" src="images/pelayanan/<?php echo $show['nm_gbr'] ?>"><?php echo $show['deskripsi'] ?>
            </div>
          </div>
        </div>
      </div>
