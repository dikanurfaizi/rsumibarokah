...
$kategori = $_GET['kt'];
$nama_ruangan = $_GET['nm'];
$hasil = mysqli_query($connect,"SELECT * FROM ruangan WHERE kategori LIKE '%$kategori' AND nm_ruangan LIKE '%$nama_ruangan'");
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
       <div class="section-title line center text-center">
        <i><h6 class="subtitle"><a href="#"><br>Ruang Rawat Inap</h6></i>
        <h2 class="title"><a href=""><?php echo $show['kategori']?> <?php echo $show['nm_ruangan']; ?></a></h2>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <!-- Menampilkan data ke HTML -->
      <div class="col-lg-12 col-md-12">
        <div class="blog-box blog-2 white-bg h-100 line center">
          <div class="blog-info">
            <h4> <a href="#"><?php echo $show['kategori']?> <?php echo $show['nm_ruangan']; ?></a></h4>
            ...
            <br>
            <div style="text-align: justify; width:100%; padding:8px;"><img style="float: left; margin:0 8px 4px 0;" width="40%" height="40%" src="images/ruangan/<?php echo $show['nm_foto'] ?>"><?php echo $show['deskripsi'] ?>
            </div>
          </div>
        </div>
      </div>
